...
flow.append(para('<b>Interface &amp; Defect Engineering for Memory and Computing</b>'))
flow.append(para('Research interests: memristors for neuromorphic and compute-in-memory functions; DRAM MIM capacitors; ALD-based thin films; electrical characterization; charge transport and trap / defect dynamics. Integrated memory and computing is a long-term direction.'))
heading('Education')
