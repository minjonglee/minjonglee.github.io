...
상단 `CV ↓`는 `assets/min-jong-lee-cv.pdf`를 바로 내려받습니다. 원본 CV를 기반으로 만든 공개 버전으로, 전화번호와 상세 우편주소를 제외했습니다. 연구 정체성 설명은 웹 CV와 동일하게 유지합니다. 경력·논문·특허 상태의 기준은 **2026년 9월 2일 업데이트 CV**입니다. 한국어 과제·수상명은 원문과 설명용 영어 번역을 함께 보존했습니다.
